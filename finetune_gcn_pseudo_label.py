...
csv_file = f'{results_dir}/scaffaug_st_gcn_finetuning_{args.dataset}_{args.split}_{timestamp}.csv'
...
for seed in seeds:
    ...
    try:
        ...
        final_results_csv = f'{results_dir}/scaffaug_st_gcn_final_{args.dataset}_{args.split}_{timestamp}.csv'
