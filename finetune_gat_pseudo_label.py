...
csv_file = f'{results_dir}/scaffaug_st_gat_finetuning_{args.dataset}_{args.split}_{timestamp}.csv'
...
for seed in seeds:
    ...
    try:
        ...
        final_results_csv = f'{results_dir}/scaffaug_st_gat_final_{args.dataset}_{args.split}_{timestamp}.csv'
