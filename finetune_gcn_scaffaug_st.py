...
results_dir = 'scaffaug_gcn_results'
os.makedirs(results_dir, exist_ok=True)

# Create CSV file with headers
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
finetuning_csv_file = f'{results_dir}/gcn_scaffaug_st_finetuning_{args.dataset}_{args.split}_{timestamp}.csv'
final_results_csv = f'{results_dir}/gcn_scaffaug_st_final_{args.dataset}_{args.split}_{timestamp}.csv'
...
if seed_results:
    ...
    summary_csv = f'{results_dir}/gcn_scaffaug_st_summary_stats_{args.dataset}_{args.split}_{timestamp}.csv'
